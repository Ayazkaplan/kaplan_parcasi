                ...
                rx.cond(
                    ...
                    rx.vstack(
                        ...
                        rx.slider(
                            ...
                            on_value_change=TepeEditorStatePart2.set_glow_intensity,
                            min=5,
                            max=150,
                            step=5,
                            width="100%",
                ...
                rx.cond(
                    ...
                    rx.vstack(
                        ...
                        rx.slider(
                            ...
                            on_value_change=TepeEditorStatePart2.set_shadow_intensity,
                            min=5,
                            max=100,
                            step=5,
                            width="100%",
                ...
                rx.cond(
                    ...
                    rx.vstack(
                        ...
                        rx.slider(
                            ...
                            on_value_change=TepeEditorStatePart2.set_media_size,
                            min=20,
                            max=500,
                            step=5,
                            width="100%",
                ...
                rx.vstack(
                    ...
                    rx.cond(
                        ...
                        rx.vstack(
                            ...
                            rx.slider(value=[TepeEditorStatePart4.glow_intensity], on_value_change=lambda val: TepeEditorStatePart4.set_glow_intensity(val[0]), min=0, max=100),
                            width="100%"
                        )
                    ),
                    spacing="3",
